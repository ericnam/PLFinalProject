...
_lr_productions = [
  ...
  ('list -> LPAREN items RPAREN','list',3,'p_list','yacc.py',153),
  ('items -> item items','items',2,'p_items','yacc.py',157),
  ('items -> empty','items',1,'p_items_empty','yacc.py',161),
  ('empty -> <empty>','empty',0,'p_empty','yacc.py',165),
  ('item -> atom','item',1,'p_item_atom','yacc.py',169),
  ('item -> quoted_list','item',1,'p_item_list','yacc.py',177),
  ('item -> call','item',1,'p_item_call','yacc.py',181),
  ('item -> empty','item',1,'p_item_empty','yacc.py',185),
  ('call -> LPAREN SIMB items RPAREN','call',4,'p_call','yacc.py',189),
  ('atom -> SIMB','atom',1,'p_atom_simbol','yacc.py',200),
