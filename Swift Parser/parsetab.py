...
_lr_productions = [
  ...
  ('exp -> atom','exp',1,'p_exp_atom','yacc.py',40),
  ('exp -> quoted_list','exp',1,'p_exp_qlist','yacc.py',44),
  ('exp -> call','exp',1,'p_exp_call','yacc.py',48),
  ('quoted_list -> QUOTE list','quoted_list',2,'p_quoted_list','yacc.py',52),
  ('list -> LPAREN items RPAREN','list',3,'p_list','yacc.py',59),
  ('items -> item items','items',2,'p_items','yacc.py',63),
  ('items -> empty','items',1,'p_items_empty','yacc.py',67),
  ('empty -> <empty>','empty',0,'p_empty','yacc.py',71),
  ('item -> atom','item',1,'p_item_atom','yacc.py',75),
  ('item -> quoted_list','item',1,'p_item_list','yacc.py',83),
  ('item -> call','item',1,'p_item_call','yacc.py',87),
  ('item -> empty','item',1,'p_item_empty','yacc.py',91),
  ('call -> LPAREN SIMB items RPAREN','call',4,'p_call','yacc.py',95),
  ('atom -> SIMB','atom',1,'p_atom_simbol','yacc.py',106),
  ('atom -> bool','atom',1,'p_atom_bool','yacc.py',110),
  ('atom -> NUM','atom',1,'p_atom_num','yacc.py',114),
  ('atom -> TEXT','atom',1,'p_atom_word','yacc.py',118),
  ('atom -> <empty>','atom',0,'p_atom_empty','yacc.py',122),
  ('bool -> TRUE','bool',1,'p_true','yacc.py',126),
  ('bool -> FALSE','bool',1,'p_false','yacc.py',130),
  ('atom -> NIL','atom',1,'p_nil','yacc.py',134),
]
