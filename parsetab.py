...
_lr_productions = [
  ...
  ('list -> LPAREN items RPAREN','list',3,'p_list','yacc.py',165),
  ('items -> item items','items',2,'p_items','yacc.py',169),
  ('items -> empty','items',1,'p_items_empty','yacc.py',173),
  ('empty -> <empty>','empty',0,'p_empty','yacc.py',177),
  ('item -> atom','item',1,'p_item_atom','yacc.py',181),
  ('item -> quoted_list','item',1,'p_item_list','yacc.py',189),
  ('item -> call','item',1,'p_item_call','yacc.py',193),
  ('item -> empty','item',1,'p_item_empty','yacc.py',197),
  ('call -> LPAREN SIMB items RPAREN','call',4,'p_call','yacc.py',201),
  ('atom -> SIMB','atom',1,'p_atom_simbol','yacc.py',212),
  ('atom -> bool','atom',1,'p_atom_bool','yacc.py',216),
  ('atom -> NUM','atom',1,'p_atom_num','yacc.py',220),
  ('atom -> TEXT','atom',1,'p_atom_word','yacc.py',224),
  ('atom -> <empty>','atom',0,'p_atom_empty','yacc.py',228),
  ('bool -> TRUE','bool',1,'p_true','yacc.py',232),
  ('bool -> FALSE','bool',1,'p_false','yacc.py',236),
  ('atom -> NIL','atom',1,'p_nil','yacc.py',240),
]
